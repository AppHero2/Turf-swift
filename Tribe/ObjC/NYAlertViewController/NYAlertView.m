...
#define COLOR_BACKGROUND [UIColor colorWithRed:248.0/255.0 green:247.0/255.0 blue:248.0/255.0 alpha:1.0]
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        self.alertBackgroundView.backgroundColor = COLOR_BACKGROUND;
        ...
        [self.alertBackgroundView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-20-[_titleLabel]-10-[_messageTextView]-15-[_contentViewContainerView][_textFieldContainerView][_actionButtonContainerView]-|"
                                                                                         options:0
                                                                                         metrics:nil
                                                                                           views:NSDictionaryOfVariableBindings(_titleLabel,
                                                                                                                                _messageTextView,
